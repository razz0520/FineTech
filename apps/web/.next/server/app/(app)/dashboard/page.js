(() => {
  ...
  ((a.id = 536),
    ...
    (a.modules = {
      ...
      24929: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 28762));
      },
      26713: (a) => {
        "use strict";
        ...
        let i = [
            {
              ...
              icon: (0, d.jsxs)("svg", {
                ...
                children: [
                  (0, d.jsx)("path", { d: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20" }),
                  (0, d.jsx)("path", {
            ...
            },
            {
              ...
              icon: (0, d.jsxs)("svg", {
                ...
                strokeLinejoin: "round",
                children: [
                  (0, d.jsx)("line", { x1: "12", y1: "1", x2: "12", y2: "23" }),
                  (0, d.jsx)("path", { d: "M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" }),
                ],
              }),
              color: "violet",
            },
            {
              ...
              icon: (0, d.jsxs)("svg", {
                ...
                children: [
                  (0, d.jsx)("path", {
                    d: "M19 20H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v1",
                  }),
                  (0, d.jsx)("path", { d: "M21 12a9 9 0 0 0-9-9" }),
                  (0, d.jsx)("path", { d: "M21 12H12V3" }),
                ],
              }),
              color: "amber",
            },
          ...
          j = [
            ...
            },
            {
              ...
              description:
                "Cold-engine LSTM+Attention simulators for market dependency verification.",
              icon: (0, d.jsx)("svg", {
                width: "22",
                height: "22",
                viewBox: "0 0 24 24",
                ...
                strokeLinecap: "round",
                strokeLinejoin: "round",
                children: (0, d.jsx)("polyline", { points: "22 12 18 12 15 21 9 3 6 12 2 12" }),
              }),
            },
            {
              href: "/portfolio",
              ...
              icon: (0, d.jsxs)("svg", {
                ...
                children: [
                  ...
                  (0, d.jsx)("path", { d: "M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" }),
                ],
              }),
            },
          ],
        ...
        function l() {
          let [a, b] = (0, e.useState)(0),
            ...
            r = {
              enrollments: p ? "—" : `${a}`,
              xp: p ? "—" : `${l}`,
              portfolio: p ? "—" : null !== c ? `$${c.toLocaleString()}` : "No portfolio",
              news: p ? "—" : `${n}`,
            };
          return (0, d.jsxs)("div", {
            className: "space-y-8 animate-fade-in font-mono",
            children: [
              (0, d.jsxs)("div", {
                children: [
                  (0, d.jsx)("h2", {
                    ...
                    children: (0, d.jsx)("span", {
                      ...
                      children: "[INIT] Operator Dashboard: Rahul",
                    }),
                  }),
                  (0, d.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, d.jsx)("div", { className: "w-1 h-1 rounded-full bg-slate-700" }),
                      (0, d.jsxs)("p", {
                        className: "text-xs text-slate-500 uppercase tracking-widest",
                        children: [
                          "Identity: ",
                          (0, d.jsx)("span", { className: "text-white", children: "RAHUL_0520" }),
                        ],
                      }),
                    ],
                  }),
                  l <= 1250 &&
                    !p &&
                    (0, d.jsx)("div", {
                      className: "mt-4 p-3 bg-rose-500/5 border border-rose-500/20 rounded-xl",
                      children: (0, d.jsx)("p", {
                        className: "text-xs text-rose-400 font-bold tracking-tight",
                        children:
              ...
              (0, d.jsx)("div", {
                className: "grid gap-4 md:grid-cols-2 lg:grid-cols-4 stagger-children",
                children: i.map((a) => {
                  let b = k[a.color];
                  return (0, d.jsxs)(
                    "div",
                    {
                      className: `glass-card p-5 border-t-2 ${b.topBorder}`,
                      children: [
                        (0, d.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, d.jsx)("div", {
                              className: `p-2 rounded-lg ${b.iconBg}`,
                              children: (0, d.jsx)("span", {
                                className: b.iconText,
                                children: a.icon,
                              }),
                            }),
                          ],
                        ...
                        (0, d.jsx)("p", {
                          className: `text-2xl font-bold ${p ? "animate-pulse text-slate-600" : "text-white"}`,
                          children: r[a.key],
                        }),
                        (0, d.jsx)("p", {
                          className: "text-[10px] text-slate-500 uppercase tracking-tight mt-1",
                          children: a.subtitle,
                        }),
                      ],
                    },
              ...
              (0, d.jsxs)("div", {
                children: [
                  (0, d.jsx)("h3", {
                    ...
                    children: "[INIT] Logic Controllers",
                  }),
                  (0, d.jsx)("div", {
                    className: "grid gap-4 md:grid-cols-3 stagger-children",
                    children: j.map((a) =>
                      (0, d.jsxs)(
                        g(),
                        {
                          href: a.href,
                          className:
                            "glass-card gradient-border p-5 block group hover:translate-y-[-2px] transition-all duration-300",
                          children: [
                            (0, d.jsxs)("div", {
                              ...
                              children: [
                                (0, d.jsx)("div", {
                                  className:
                                    "p-2 rounded-lg bg-cyan-500/10 text-cyan-400 group-hover:bg-cyan-500/20 transition-colors border border-cyan-500/20",
                                  children: a.icon,
                                }),
                                (0, d.jsx)("h3", {
                                  className:
                                    "text-xs font-bold text-slate-200 group-hover:text-white transition-colors uppercase tracking-tight",
                                  children: a.title,
                                }),
                              ],
                            }),
                            (0, d.jsx)("p", {
                              className: "text-[11px] text-slate-500 leading-relaxed font-sans",
              ...
              (0, d.jsx)(h.StrategicRealityCheck, {}),
            ],
          });
        }
      },
      ...
      31806: (a, b, c) => {
        ...
        let G = {
                    ...
                    children: [
                      "dashboard",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 73104)),
                              "C:\\Users\\ASUS\\FineTech\\apps\\web\\app\\(app)\\dashboard\\page.tsx",
                            ],
                          },
                        ],
                      },
          ...
          H = ["C:\\Users\\ASUS\\FineTech\\apps\\web\\app\\(app)\\dashboard\\page.tsx"],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      73104: (a, b, c) => {
        ...
        let d = (0, c(38676).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"C:\\\\Users\\\\ASUS\\\\FineTech\\\\apps\\\\web\\\\app\\\\(app)\\\\dashboard\\\\page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "C:\\Users\\ASUS\\FineTech\\apps\\web\\app\\(app)\\dashboard\\page.tsx",
          "default",
      ...
      86158: (a, b, c) => {
        ...
        function d(a, b, c = 2) {
          let e = [a];
          for (let a = 1; a < b; a++) {
            let b = (Math.random() - 0.48) * c;
            e.push(+(e[a - 1] + b).toFixed(2));
          }
          return e;
        }
        function e(a) {
          let b = [],
            c = Date.now();
          for (let d = a - 1; d >= 0; d--) {
            let a = new Date(c - 864e5 * d);
            b.push(a.toISOString().slice(0, 10));
          }
          return b;
        }
        c.d(b, {
        ...
        let f = { AAPL: 185, MSFT: 420, GOOGL: 175, AMZN: 195, META: 510 };
        function g(a, b = 90) {
          let c = d(f[a] || 100, b);
          return e(b).map((a, b) => {
            let d = c[b],
              e = +(d + (Math.random() - 0.5) * 2).toFixed(2);
            return {
              timestamp: a + "T16:00:00Z",
              open: e,
              high: +(Math.max(e, d) + 3 * Math.random()).toFixed(2),
              low: +(Math.min(e, d) - 3 * Math.random()).toFixed(2),
              close: d,
              volume: Math.round(5e6 * Math.random() + 1e6),
            };
          });
        }
        let h = [
        ...
        function i(a) {
          let b = a[a.length - 1] || 100,
            c = a[a.length - 2] || b,
            d = +((b - c) / c).toFixed(6);
          return {
            predicted_return: d,
            direction: d >= 0 ? "up" : "down",
            uncertainty: +(0.3 * Math.random() + 0.05).toFixed(4),
        ...
        function j(a) {
          let b = i(a);
          return {
            predicted_return: b.predicted_return,
            attention_weights: b.attention_weights,
            feature_contributions: b.attention_weights.map((a, b) => ({
              timestep: b,
              attention: a,
              description: `t-${10 - b}`,
            })),
        ...
        function k(a) {
          let b = i(a),
            c = b.direction,
            d = Math.max(...b.attention_weights);
          return {
            predicted_return: b.predicted_return,
            attention_weights: b.attention_weights,
            narrative: `[CALC] The attention mechanism assigned a peak weight of ${d.toFixed(2)} to the T-minus-2 price action, indicating a non-linear dependency. Predicted ${c}ward delta is purely mechanical.`,
            bullet_points: [
              "[OK] Temporal weights concentrated in session T-minus-2.",
              `[CALC] Predicted return volatility variance: ${b.uncertainty.toFixed(4)}.`,
              `[WARN] Nominal ${c}ward trend ignores macro-economic liquidity constraints.`,
            ],
          };
        }
        function l() {
          return [
            {
              ...
              positions: [
                ...
                { symbol: "MSFT", quantity: 18, cost_basis: 412 },
                { symbol: "GOOGL", quantity: 22, cost_basis: 172.5 },
                { symbol: "AMZN", quantity: 24, cost_basis: 191 },
              ],
              total_value: 25730.5,
            },
          ];
        ...
        function m() {
          return { sharpe_ratio: 2.81, var_95: 0.0233, volatility: 0.0185 };
        }
        function n(a = 30) {
          let b = e(a),
            c = d(25730.5, a, 200);
          return b.map((a, b) => ({ date: a, total_value: +c[b].toFixed(2) }));
        }
        function o(a) {
          return [
            {
              id: "n1",
              title: `[INIT] ${a || "AAPL"} quarterly variance report: -0.4% delta vs expectations`,
              url: null,
            },
            {
              id: "n2",
              title: "[OK] Fed rate cycle transition: impact assessment pending",
              url: null,
            },
            { id: "n3", title: "[CALC] Tech sector concentration risk index: +2.4pts", url: null },
            {
              id: "n4",
              title:
                "[INIT] Global liquidity flow analysis indicates capital flight to high-yield bonds",
              url: null,
            },
            {
              id: "n5",
              title: `[WARN] Analyst downgrade cycle initiated for ${a || "AAPL"}`,
              url: null,
            },
          ];
        }
        function p() {
          return { enrollments: 3, xp: 1250, portfolioValue: 25730.5, newsCount: 12 };
        }
        let q = {
          diversif:
        ...
        function r(a) {
          ...
          for (let [a, d] of Object.entries(q))
            if (b.includes(a)) {
              c = d;
              break;
            }
      ...
      86539: (a, b, c) => {
        "use strict";
        c.d(b, { tE: () => d });
        let d = process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8000";
        process.env.NEXT_PUBLIC_DEV_USER_ID;
      },
      88481: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 73104));
      ...
      91179: (a, b, c) => {
        ...
        function g() {
          let a = f[(0, e.usePathname)()] || f.default;
          return (0, d.jsxs)("div", {
            className: "mt-12 pt-8 border-t border-white/5 animate-fade-in",
            children: [
              (0, d.jsx)("h3", {
                className: "text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4",
                children: "[CALC] Strategic Reality Check",
              }),
              (0, d.jsx)("div", {
                className:
                  "glass-panel p-6 rounded-2xl border-rose-500/10 bg-rose-500/5 group hover:bg-rose-500/10 transition-all duration-500",
                children: (0, d.jsxs)("p", {
                  className:
                    "text-sm font-mono text-slate-400 leading-relaxed italic group-hover:text-slate-300 transition-colors",
                  children: ['"', a, '"'],
                }),
              }),
            ],
  ...
  b.C(a);
  var c = b.X(0, [142, 525], () => b((b.s = 31806)));
  module.exports = c;
})();
